...
import com.example.demo_news.adapter.MovieArticleAdapter;
import com.example.demo_news.model.Source;
import com.example.demo_news.view_model.ArticleViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Source> articleArrayList = new ArrayList<>();
    ...
    private void getMovieArticles() {
        articleViewModel.getArticleResponseLiveData().observe(this, articleResponse -> {
            if (articleResponse != null) {
                ...
                List<Source> articles = articleResponse.getSources();
